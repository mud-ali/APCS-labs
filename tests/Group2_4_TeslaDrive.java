...
public class Group2_4_TeslaDrive extends BCATestScenario{
    public int runTest(){
        ...
        c1.drive(0);
        assertEquals(c1.getMileage(), 0, 0.1, "Mileage should be 0");

        c1.drive(50);
        assertEquals(c1.getMileage(), 50, 0.1, "Mileage should be 50");

        c1.drive(110);
        assertEquals(c1.getMileage(), 160, 0.1, "Mileage should be 160");
        ...
        assertThrows(IllegalArgumentException.class, () -> {c1.drive(180.1);}, "Driving more than the remaining range should throw an exception.");
