...
public class Group3_1_HondaAccordianWithMileage_Constructor extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertEquals(c1.getRemainingRange(), 500, 0.1, "Mileage should equal 500");
        ...
        assertEquals(c1.toString(), "2018 Honda Accordian (500.0 mi)",
                "toString() should print '2018 Honda Accordian (500.0 mi)'");
        ...
        c1.drive(50);
        assertEquals(c1.getRemainingRange(), 550.0, 0.1, "Mileage should be 550.0 after driving 50 miles");
