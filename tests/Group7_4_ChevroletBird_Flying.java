...
public class Group7_4_ChevroletBird_Flying extends BCATestScenario{
    ...
    public int runTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {c4.fly(-1);}, "Flying mileage can not be negative");

        c4.fly(30);

        assertEquals(c4.getMileage(), 0, .1, "Car mileage should remain 0");
        ...
        assertThrows(IllegalArgumentException.class, () -> {c4.fly(21);}, "21 mileage goes over the Car's maximum mileage");
