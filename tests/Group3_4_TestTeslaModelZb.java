...
public class Group3_4_TestTeslaModelZb extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            t3.driveAutonomously(-1);
        }, "neg autonomous -- supposed to throw IllegalArgumentException");
        // run drive 0 verify no eception, mileage 0
        t3.driveAutonomously(30);
        assertEquals(t3.getRemainingRange(), 30, 0.1, "Wrong Mileage");
        t3.driveAutonomously(300);
        assertEquals(t3.getRemainingRange(), 330, 0.1, "Wrong Mileage");
        assertEquals(t3.getRemainingRange(), 10, 0.1, "Wrong Remaining Range");
        t3.driveAutonomously(9);
        assertEquals(t3.getRemainingRange(), 339, 0.1, "Wrong Mileage");
