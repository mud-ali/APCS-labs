...
public class Group2_1_TestChevroletBird1_Constructors extends BCATestScenario{
    public int runTest() { 
        ...
        assertThrows(IllegalArgumentException.class, ()->{new ChevroletBird(-20);}, 
        "Cannot have a negative startingMileage");

        ChevroletBird b1 = new ChevroletBird(20);
        b1.drive(20);

        assertEquals(b1.getMileage(), 40, 0.1, "getMileage should return 40");
        ...
        assertThrows(IllegalArgumentException.class, ()->{b1.drive(-5);}, "Cannot drive negative miles");

        assertThrows(IllegalArgumentException.class, ()->{b1.drive(251);}, "You do not have enough charge to drive 251 miles");
        ...
        assertEquals(b1.getMileage(), 290, 0.1, "getMileage() should now return 290");

        ChevroletBird b2 = new ChevroletBird();

        assertEquals(b2.getMileage(), 0, 0.1, "getMileage() should return 0 since it was just instantiated");

        assertEquals(b2.getRemainingRange(), 250, 0.1, "getRemainingRange() should return 250");

        assertThrows(IllegalArgumentException.class, ()->{b2.drive(-1);}, "Cannot drive negative miles");
        ...
        assertThrows(IllegalArgumentException.class, ()->{b2.drive(1);}, "You cannot drive 1 mile with the charge you have");
        ...
        assertThrows(IllegalArgumentException.class, ()->{b2.canDrive(-6);}, "You cannot drive negative miles");
        ...
        assertEquals(b2.getMileage(), 300, 0.1, "getMileage() should return 300");
        ...
        assertThrows(IllegalArgumentException.class, ()->{b2.roadTrip(m1);}, "You cannot drive negative miles");
