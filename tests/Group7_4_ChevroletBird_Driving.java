...
public class Group7_4_ChevroletBird_Driving extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertEquals(c3.getRemainingRange(), 30.0, 1, "Car should have 30 mileage");

        c3.drive(200);

        assertEquals(c3.getRemainingRange(), 230, .1, "Car should have 230 mileage");
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            c3.drive(21);
        }, "Driving 21 miles is over the maximum mileage");
