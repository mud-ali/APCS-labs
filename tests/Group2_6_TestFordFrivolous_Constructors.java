...
public class Group2_6_TestFordFrivolous_Constructors extends BCATestScenario {
    public int runTest() {
        ...
        assertEquals(t1.getMileage(), 0.0, 0.1, "Starting mileage for t1 should be 0.");

        assertEquals(t2.getMileage(), 10.1, 0.1, "Starting mileage for t2 should be 10.1.");
        assertEquals(t3.getMileage(), 0.0, 0.1, "Starting mileage for t3 should be 0.");
