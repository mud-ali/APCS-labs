...
public class Group3_1_ChevroletBirdNoMileage_Constructors extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertEquals(c1.getRemainingRange(), 0.0, 0.1, "Initial mileage should be 0"); // 0.1 is delta change
        ...
        c1.drive(10);
        assertEquals(c1.getRemainingRange(), c1.getMaxRange() - 10, 0.1,
                "Remaining range should be updating after driving");
        assertEquals(c1.getRemainingRange(), 10.0, 0.1, "Mileage driven should be updated after driving");
        c1.recharge();
        ...
        c1.fly(20);
        assertEquals(c1.getRemainingRange(), 10.0, 0.1, "flying must not count toward mileage");
