...
public class Group7_3_HondaAccordian_Constructor2 extends BCATestScenario {
    public int runTest() {
        assertThrows(IllegalArgumentException.class, () -> {HondaAccordian c1 = new HondaAccordian(-1, 2018);}, "Driving mileage cannot be neg.");
        HondaAccordian c2 = new HondaAccordian(10, 2019);
        assertEquals(c2.getMileage(), 10, .1, "Car should begin with 10 mileage");
