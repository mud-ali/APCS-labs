...
public class Group2_6_TestTeslaModelZ_Constructors extends BCATestScenario {
    public int runTest() {
        ...
        assertEquals(t1.getRemainingRange(), 0, 0.1, "Tesla's starting mileage should be 0.");
        assertEquals(t1.getModelNum(), 4, "Tesla's model number should be 4.");

        assertEquals(t2.getRemainingRange(), 12.0, 0.1, "Tesla's starting mileage should be 12.0.");
        ...
        assertEquals(t3.getRemainingRange(), 0, 0.1, "Mileage should be 0.");
