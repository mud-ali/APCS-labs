...
public class Group3_1_HondaAccordianNoMileage_Constructor extends BCATestScenario {

    @Override
    public int runTest() {
        HondaAccordian c1 = new HondaAccordian(2018);
        assertEquals(c1.getRemainingRange(), 0, 0.1, "Mileage should equal 0");
        ...
        assertEquals(c1.toString(), "2018 Honda Accordian (0.0 mi)",
                "toString() should print '2018 Honda Accordian (0.0 mi)'");
        assertThrows(IllegalArgumentException.class, () -> {
            c1.drive(500);
        }, "Driving 500 miles should throw an IllegalArgumentException");
        assertThrows(IllegalArgumentException.class, () -> {
            c1.drive(-10);
        }, "Driving -10 miles should throw an IllegalArgumentException");
        c1.drive(50);
        assertEquals(c1.getRemainingRange(), 50.0, 0.1, "Mileage should be 50.0 after driving 50 miles");
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            c1.refillTank(-10);
        }, "Refilling tank with -10 gallons should throw an IllegalArgumentException");
        assertThrows(IllegalArgumentException.class, () -> {
            c1.refillTank(10);
        }, "Refilling tank beyond capacity should throw an IllegalArgumentException");
        c1.drive(66.4);
        assertEquals(c1.getFuelLevel(), 12.5, 0.1, "Fuel level should equal 12.5");
        c1.refillTank(2);
        assertEquals(c1.getRemainingRange(), 481.4, 0.1,
                "Refilling tank to full should have a remaining range of 481.4");
