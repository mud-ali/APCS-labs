...
public class Group3_3TestFordFrivolous extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new FordFrivolous(-1.0);
        }, "Starting mileage can't be negative");
        ...
        assertEquals(a.getRemainingRange(), 15, 0.1, "Mileage should equal 15 when parameter is 15");
        ...
        assertEquals(c.getRemainingRange(), 20 * 23.6, 0.1,
                "Remaining range should be fuel capacity * mpg in empty constructor");
