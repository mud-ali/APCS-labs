...
public class Group3_2_Tesla2_Driving extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {c1.drive(341);}, 
        ...
        c1.drive(20);
        assertEquals(c1.getMileage(), 20, 0.01, "Mileage should be 20");

        assertTrue(c1.canDrive(200.2), "canDrive(200.2) should be true");
        c1.drive(200.2);
        assertEquals(c1.getMileage(), 220.2, 0.01, "Mileage should be 220.2");
        ...
        c1.drive(119);
        assertEquals(c1.getMileage(), 339.2, 0.01, "Mileage should be 339.2");

        assertThrows(IllegalArgumentException.class, () -> {c1.drive(0.9);}, 
                    "Too high of a mileage should throw IllegalArgumentException");
...
/*        c1.decreaseCharge(20);
        assertEquals(c1.getRemainingRange(), 320, 0.01, "Remaining range should be 320");

        assertThrows(IllegalArgumentException.class, () -> {c1.addMileage(-10);},
                    "Adding a negative mileage should throw an exception");
        
        c1.addMileage(10);
        assertEquals(c1.getMileage(), 349.2, 0.01, "Mileage should be 349.2");
*/
