...
public class Group2_6_TestTeslaModelZ_Drive extends BCATestScenario {
        public int runTest() {
                ...
                t.drive(10.1);
                assertEquals(t.getRemainingRange(), 10.1, .1, "Mileage is incorrect.");
                ...
                assertEquals(t.getRemainingRange(), 340, .1, "Mileage is incorrect.");
                ...
                assertEquals(t2.getRemainingRange(), 0.0, 0.1, "Driving 0 miles should keep the mileage at 0.");

                t2.driveAutonomously(t.getRemainingRange());

                assertEquals(t2.getRemainingRange(), 340.0, 0.1,
                                "Driving 340 miles should increase the mileage to 340.");
                ...
                assertEquals(t.getRemainingRange(), 355.0, .1, "Roadtrip is incorrect.");

                list.clear();
                list.add(t.getRemainingRange());
                list.add(.1);
                assertEquals(t.roadTrip(list), 1, "Roadtrip is incorrect.");
                assertEquals(t.getRemainingRange(), 680.0, .1, "Roadtrip is incorrect.");
