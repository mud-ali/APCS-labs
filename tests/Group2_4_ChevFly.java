...
public class Group2_4_ChevFly extends BCATestScenario {
    public int runTest() {
        ...
        assertEquals(c1.getMileage(), 0, 0.1, "Mileage should still be 0");

        c1.drive(100);
        assertFalse(c1.checkWingsExtended(), "checkWingsExtended should return false");

        assertThrows(IllegalArgumentException.class, () -> {c1.fly(101);}, 
        "Should throw exception if car cannot fly the given number of miles");
        assertThrows(IllegalArgumentException.class, () -> {c1.fly(-1);}, 
