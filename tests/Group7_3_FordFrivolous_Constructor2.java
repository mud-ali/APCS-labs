...
public class Group7_3_FordFrivolous_Constructor2 extends BCATestScenario {
    public int runTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {FordFrivolous c1 = new FordFrivolous(-1);}, "Driving mileage cannot be neg.");
        ...
        assertEquals(c2.getMileage(), 10, 0.1, "Car should begin with 0 mileage");
